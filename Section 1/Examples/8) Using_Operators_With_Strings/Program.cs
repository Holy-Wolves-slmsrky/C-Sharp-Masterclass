...
/*
 * num1 / num2 = 0 because the variables num1 and num2 are of the integer data type.
 * "Integer / Integer" operation gives an Integer type value.
 * If a variable were of the double data type, the result would be of the double data type.

 * num1 / num2 = 0 değerini verdi çünkü num1 ve num2 değişkenleri integer veri tipindedir.
 * "Integer / Integer" işlemi, Integer tipi değer verir.
 * Bir değişken double veri tipinde olsaydı, sonuç double veri tipinde olurdu.
 */

double num3 = 5;
double num4 = 13;

Console.WriteLine("num1 / num2 = " + (num1 / num4));
